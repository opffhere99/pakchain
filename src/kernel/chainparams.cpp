// PakChain - Based on Bitcoin Core
// Copyright (c) 2026 PakChain developers
...
{
    const char* pszTimestamp = "PakChain 08/Jun/2026 First blockchain built in Pakistan";
...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        genesis = CreateGenesisBlock(1749358800, 1119161, 0x1e0fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256{"000001499bf3387db7e504ce0cad0a66aa9a29e09fa461335005a24212f84fbd"});
        // assert(genesis.hashMerkleRoot == uint256{"6c310f78a2e69db55741bb8202ebc2f6c5f825a166b4b63ce49d053b9165b026"});
