...
const QString BITCOIN_IPC_PREFIX("pakchain:");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start pakchain: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    {
        Q_EMIT message(tr("URI handling"), tr("'pakchain://' is not a valid URI. Use 'pakchain:' instead."),
